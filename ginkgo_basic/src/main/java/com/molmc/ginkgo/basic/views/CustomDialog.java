...
public class CustomDialog extends AlertDialog {
    ...
    public static class NormalBuilder extends Builder {
        ...
        void setView(CustomDialog dialog) {
            View dialogView = LayoutInflater.from(mContext).inflate(R.layout.basic_dialog_normal, null);
    ...
    public static class StateBuilder extends Builder {
        ...
        @Override
        void setView(CustomDialog dialog) {
            View dialogView = LayoutInflater.from(mContext).inflate(R.layout.basic_dialog_state, null);
    ...
    public static class CheckBoxBuilder extends Builder {
        ...
        @Override
        void setView(CustomDialog dialog) {
            View dialogView = LayoutInflater.from(mContext).inflate(R.layout.basic_dialog_check_box, null);
    ...
    public static class ProgressBuilder extends Builder {
        ...
        @Override
        void setView(CustomDialog dialog) {
            View dialogView = LayoutInflater.from(mContext).inflate(R.layout.basic_dialog_progress, null);
    ...
    public static class EditTextBuilder extends Builder {
        ...
        @Override
        void setView(CustomDialog dialog) {
            View dialogView = LayoutInflater.from(mContext).inflate(R.layout.basic_dialog_edit_text, null);
