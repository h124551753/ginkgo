...
public class AlphaTabView extends View {
    ...
    private int mTextSize;                        //描述文本的默认字体大小 12sp
    private int mPadding;                         //文字和图片之间的距离 5dp
    ...
    public AlphaTabView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mPadding = (int) a.getDimension(R.styleable.AlphaTabView_paddingTextIcon, mPadding);
        a.recycle();
        initText();
    }
