package com.molmc.ginkgo.basic.biz;
...
import com.molmc.ginkgo.basic.constants.FileType;
import com.molmc.ginkgo.basic.constants.Formatter;
...
public class BasicBiz {
    ...
    public static void checkVersionUpdate(Context context, Object tag, boolean showHint) {
        ...
        NetDataSource.post(tag, Urls.CHECK_UPDATE, httpParams, new ResponseListener<UpdateEntity>() {
            ...
            public UpdateEntity convert(String jsonStr) {
                return new Gson().fromJson(jsonStr, UpdateEntity.class);
            }
    ...
    public static TimePickerView getMyTimePickerBuilder(Context context, OnTimeSelectListener listener) {
    ...
    public static OptionsPickerView getMyOptionPickerBuilder(Context context, OnOptionsSelectListener listener) {
        //条件选择器
