...
import com.molmc.ginkgo.basic.views.WrapContentListView;
import com.molmc.ginkgo.user.R;
import com.molmc.ginkgo.user.activity.signup.SignUpActivity;
import com.molmc.ginkgo.user.activity.user.UserActivity;
import com.molmc.ginkgo.user.adapter.UserListAdapter;
...
public class LoginActivity extends BaseActivity implements LoginContract.View,
    ...
    private TextWatcher mTextWatcher = new TextWatcher() {
        ...
        public void afterTextChanged(Editable editable) {
            ...
            if (userEntity != null) {
                ImageLoader.loadAddress(civHead, userEntity.getHeaderUrl(), R.mipmap.basic_ic_head_single, R.mipmap.basic_ic_head_single);
                etPassword.setText(userEntity.getPassword());
            } else {
                ImageLoader.loadRes(civHead, R.mipmap.basic_ic_head_single);
                etPassword.setText("");
            }
        }
    };
    ...
    private void initUserListPopup() {
        ...
        userListAdapter.setDeleteBtnClickListener(userEntity -> {
            ...
            if (TextUtils.equals(userEntity.getUsername(), getText(etUsername))) {
                ...
                etUsername.setText("");
                etPassword.setText("");
                civHead.setImageResource(R.mipmap.basic_ic_head_single);
            }
            if (mAllSavedUser.size() == 0) {
