...
package com.molmc.ginkgo.scanner.view;
...
public final class ViewfinderView extends View {
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        int textSizeDefault = (int) (16 * fontScale + 0.5F);
        labelTextSize = array.getFloat(R.styleable.ViewfinderView_label_text_size, textSizeDefault);
        array.recycle();
    ...
    private void drawTextInfo(Canvas canvas, Rect frame) {
        ...
        int i = (int) (25 * scale + 0.5F);
        canvas.drawText(labelText, frame.left + frame.width() / 2, frame.bottom + i, paint);
    }
